...
Gaps worth filling to keep the canon honest: a scaling-laws paper (Kaplan or Chinchilla), and GPT-2, the one remaining prequel to GPT-3. Tracked in `BACKLOG.md`.
