...
Gaps worth filling to keep the canon honest: Mixture of Experts (Shazeer 2017), a scaling-laws paper (Kaplan or Chinchilla), and the missing prequels to GPT-3 (GPT-1, GPT-2, BERT). Tracked in `BACKLOG.md`.
