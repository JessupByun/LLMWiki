...
Gaps worth filling to keep the canon honest: a scaling-laws paper (Kaplan or Chinchilla), the direct precursors to the Transformer (Bahdanau attention, Sutskever seq2seq), and the missing prequels to GPT-3 (GPT-1, GPT-2, BERT). Tracked in `BACKLOG.md`.
