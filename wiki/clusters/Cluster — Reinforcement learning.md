...
| [[Paper — Trust Region Policy Optimization (2015)]] | First policy-gradient method with a theoretically grounded monotonic-improvement guarantee at scale, via a KL-divergence-constrained update - the direct ancestor PPO simplifies into a cheap first-order objective. |
