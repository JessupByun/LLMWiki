...
- Directly replicates [[Paper — Emergent Misalignment - Narrow Finetuning can Produce Broadly Misaligned LLMs (2025)]]'s free-form evaluation methodology as one of its six core misalignment evaluations, extending that paper's finding from narrow supervised finetuning on insecure code to reward hacking learned during real RL.
