...
- **AI feedback labels are reasonably well-calibrated** (Figure 9) against the paper's own HHH evaluation set, and [[Method — Chain-of-Thought Prompting|chain-of-thought]] reasoning pushes multiple-choice harm-identification accuracy from near-chance toward the accuracy of a preference model trained on hundreds of thousands of human labels.
...
- Uses [[Method — Chain-of-Thought Prompting]], introduced in [[Paper — Chain-of-Thought Prompting Elicits Reasoning in Large Language Models (2022)]], to improve AI feedback label quality.
